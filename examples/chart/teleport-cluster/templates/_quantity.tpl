...
Helm saldy doesn't offer this critical primitive: https://github.com/helm/helm/issues/11376
The quantity serialization fomrat is described here: https://github.com/kubernetes/apimachinery/blob/master/pkg/api/resource/quantity.go#L33
