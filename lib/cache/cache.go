...
// GetApproximateCacheSize returns the combined total number of nodes, app servers, database servers, kube servers, desktops, and bot instances.
func (c *Cache) GetApproximateCacheSize() int {
	c.rw.RLock()
	defer c.rw.RUnlock()
