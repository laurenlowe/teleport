...
<Integrations
  ...
  integrations={[
    {
      ...
      href: './machine-workload-identity/deployment/aws-oidc-federation/',
      iconColor: '#FF99001A',
      iconComponent: awsSvg,
    },
    {
      ...
      href: './workload-identity/deployment/aws-roles-anywhere/',
      iconColor: '#FF99001A',
      iconComponent: awsSvg,
    },
    {
      ...
      href: './machine-workload-identity/deployment/azure-federated-credentials/',
      iconColor: '#0078D41A',
      iconComponent: azureSvg,
    },
    {
      ...
      href: './machine-workload-identity/deployment/gcp-workload-identity-federation-jwt',
      iconColor: '#06AC381A',
      iconComponent: gcpSvg,
    },
    {
      ...
      href: './machine-workload-identity/tsh/',
      iconColor: '#512FC91A',
      iconComponent: teleportSvg,
    },
  ]}
  additionalLinks={{
    ...
    links: [
    {
      ...
      href: "./machine-workload-identity/introduction-workload-id/spiff/"
    },
    {
      title: "About JWT SVIDs",
      href: "./machine-workload-identity/jwt-svids/"
    },
  ]
  }}
